...
/**
 * 컨테이너 또는 팝업으로 사이트내 페이지에 접근할 경우 컨테이너용 스타일시트를 불러온다.
 */
    ...
    <div class="top">
        <div class="container">
            ...
            <nav data-role="site">
                ...
                <a href="<?php echo $siteLink->url; ?>"><?php echo $siteLink->title; ?></a>
                <?php } ?>
            </nav>
            <?php } ?>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li><a href="<?php echo $IM->getUrl($page->menu,$page->page,false); ?>"><!-- <i class="fa fa-angle-right" aria-hidden="true"></i> --><i></i><?php echo $page->title; ?></a></li>
                            <?php } ?>
                        </ul>
                    </li>
                    <?php
                    ...
                    /**
                     * 4개의 영역이 다 체워지지 않았을 경우, 나머지 빈 영역을 추가한다.
                     */
                    if ($loop % 4 !== 0) {
                        for ($i=$loop%4; $i<4;$i++) {
                            echo '<li></li>';
